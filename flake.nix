    ...
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        fileSetForCrate = crate: lib.fileset.toSource {
          ...
          fileset = lib.fileset.unions [
            ...
            # (craneLib.fileset.commonCargoSources ./crates/arcuru-lib-hack)
      ...
      in
      {
        checks = {
          ...
          # Audit licenses
          arcuru-lib-deny = craneLib.cargoDeny {
            inherit src;
          };
          ...
          arcuru-lib-hakari = craneLib.mkCargoDerivation {
            inherit src;
            pname = "arcuru-lib-hakari";
            cargoArtifacts = null;
